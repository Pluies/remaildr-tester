"""
Django settings for remaildrtester project.
...
ALLOWED_HOSTS = ['status.remaildr.com']
...
ROOT_URLCONF = 'remaildrtester.urls'
...
WSGI_APPLICATION = 'remaildrtester.wsgi.application'
